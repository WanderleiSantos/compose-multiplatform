...
class DefaultBookRepository(
    ...
    override suspend fun getBookDescription(bookId: String): Result<String?, DataError> {
        return favoriteBookDao.getFavoriteBookById(bookId)?.let { favoriteBook ->
            Result.Success(favoriteBook.description)
    ...
    override fun isBookFavorite(bookId: String): Flow<Boolean> {
        return favoriteBookDao.getFavoriteBooks().map { bookEntities -> bookEntities.any { it.id == bookId } }
    }
